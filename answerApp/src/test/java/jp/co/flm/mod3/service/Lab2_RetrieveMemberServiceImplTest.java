/**
 * Lab2_RetrieveMemberServiceImplTest.java
...
@DisplayName("Lab2_RetrieveMemberServiceImplのテスト")
public class Lab2_RetrieveMemberServiceImplTest {

	@InjectMocks
	Lab2_RetrieveMemberServiceImpl sut;
