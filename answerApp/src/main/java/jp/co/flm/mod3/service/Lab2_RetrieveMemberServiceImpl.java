/**
 * Lab2_RetrieveMemberServiceImpl.java
 ...
 */
@Service
public class Lab2_RetrieveMemberServiceImpl
		implements Lab2_RetrieveMemberService {
	...
	/**
	 * @see Lab2_RetrieveMemberService#authenticateMember(String, String)
	 */
	@Override
